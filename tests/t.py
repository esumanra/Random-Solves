import unittest
from src import gangs_of_primes_and_composites as skillenza


class TestGangsOfPrimesAndConsonants(unittest.TestCase):
    ...
    def test_1(self):
        ...
        self.assertEqual(skillenza.gangs(grid), (2, 1))
    ...
    def test_2(self):
        ...
        self.assertEqual(skillenza.gangs(grid), (3, 4))
    ...
    def test_3(self):
        ...
        self.assertEqual(skillenza.gangs(grid), (7, 8))

    def test_4(self):
        grid = [[6, 8, 6, 2, 2, 3, 4, 5, 5, 6, 3, 8, 8, 5, 3, 2, 5, 8, 7],
        ...
        self.assertEqual(skillenza.gangs(grid), (43, 26))
